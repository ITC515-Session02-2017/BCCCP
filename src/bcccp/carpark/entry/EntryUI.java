...
public class EntryUI extends JFrame implements IEntryUI {
    ...
    public EntryUI(int x, int y) {
        ...
        panel.setBorder(
                new TitledBorder(null, "LCD Display", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        issueAdhocTicketButton.addActionListener(
                new ActionListener() {
        ...
        panel_1.setBorder(
                new TitledBorder(
                        null, "Season Ticket Reader", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        panel_2.setBorder(
                new TitledBorder(
                        null, "Entry Ticket Printer", TitledBorder.LEADING, TitledBorder.TOP, null, null));
    ...
    public void printTicket(String ticketDetails) {
        ...
        ticketPrinterTextArea.setText(ticketDetails);
    }
