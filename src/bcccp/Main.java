        ...
        new Runnable() {
          public void run() {
            try {
              ...
              EntryController entryController = new EntryController(carpark, egate, eos, eis, eui);

              @SuppressWarnings("unused")
              PaystationController payController = new PaystationController(carpark, pui);

              @SuppressWarnings("unused")
              ExitController exitController = new ExitController(carpark, xgate, xis, xos, xui);
